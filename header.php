...
<head>
	...
	<link rel="alternate" href="http://conference.agu.edu.vn/" hreflang="vi-vn" />
	...
	<meta name="author" content="Trường Đại học An Giáng" />
	...
	<?php
		...
		$GLOBALS['url_post'] = 'http://dulieukhoahoc.xyz/api';
		$GLOBALS['url_upload'] = 'http://dulieukhoahoc.xyz/upload/tlns';
	?>
	<script>
